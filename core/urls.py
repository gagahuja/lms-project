...
urlpatterns = [
    ...
    path('ai-notes/<int:lesson_id>/',views.generate_ai_notes,name='generate_ai_notes'),
    ...
    path('assignment-file/<int:assignment_id>/',views.serve_assignment_file,name='serve_assignment_file'),
    path('submission-file/<int:submission_id>/',views.serve_submission_file,name='serve_submission_file'),
    path('checked-submission-file/<int:submission_id>/',views.serve_checked_submission_file,name='serve_checked_submission_file'),
    ...
    path('answer-doubt/<int:doubt_id>/',views.answer_doubt_page,name='answer_doubt_page'),
    path('answer-doubt-submit/<int:doubt_id>/',views.answer_doubt,name='answer_doubt'),
    path('notifications/', views.notifications, name='notifications'),
    path('chat/<int:user_id>/<int:course_id>/',views.chat,name='chat'),
